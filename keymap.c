...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_all(
       ...
       KC_LSPO,       ______,  KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,    KC_N,      KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC, KC_RSPC,   TT(F_KEYS),
       TT(F_KEYS),    KC_LALT, KC_LGUI, KC_SPC,  TT(F_APPLE),     KC_SPC,  KC_RGUI,   KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT
  ),
  ...
  [F_KEYS] = LAYOUT_all(
      ______,         KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,  KC_F6,   KC_F7,     KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  KC_DEL,
...
qk_tap_dance_action_t tap_dance_actions[] = {
  [TD_GUI_MEH] = ACTION_TAP_DANCE_DOUBLE(KC_LGUI, KC_MEH)
};
