...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_all(
       ...
       KC_MEH,        KC_LALT, KC_LGUI, ______,  KC_SPC,  ______, KC_RGUI, KC_LEFT,   KC_DOWN, KC_UP,   KC_RIGHT
  ),
  ...
  [F_APPLE] = LAYOUT_all(
      ...
      ______,         ______,  ______,  ______,  ______,  ______, ______,  KC_PGDOWN, KC_PGUP, ______,  ______,  ______,  ______,
